...
public class i32x4 {
    public static class Arr {
        ...
        public void set(int index, i32x4 vec) {
        ...
        public i32x4 get(int index) {
            return new i32x4(data[4 * index + 0], data[4 * index + 1], data[4 * index + 2], data[4 * index + 3]);
        }
    }
    public static class Buf extends GL_Buf {
        public Arr local;
        public Buf(int target, BufFmt.Usage usage, int reserve) {
            super(target, BufFmt.Block(BufFmt.Type.I32, 4, usage));
    ...
    public i32x4 copy() {
        return new i32x4(x, y, z, w);
    }
    public static i32x4 of(int x, int y, int z, int w) {
        return new i32x4(x, y, z, w);
    }
    public String toString() {
        return "[" + x + "," + y + "," + z + "," + w + "]";
    }
    public static i32x4 zero() {
        return of(0, 0, 0, 0);
    }
    public static i32x4 val(int val) {
        return of(val, val, val, val);
    }
    public i32x4 set(int x, int y, int z, int w) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.w = w;
    ...
    public i32x4 cadd(i32x4 other) {
        return this.copy().add(other);
    }
    public i32x4 add(int x, int y, int z, int w) {
        this.x += x;
        this.y += y;
        this.z += z;
        this.w += w;
    ...
    public i32x4 cadd(int x, int y, int z, int w) {
        return this.copy().add(x, y, z, w);
    }
    public i32x4 sub(i32x4 other) {
        this.x -= other.x;
        this.y -= other.y;
        this.z -= other.z;
        this.w -= other.w;
    ...
    public i32x4 csub(i32x4 other) {
        return this.copy().sub(other);
    }
    public i32x4 sub(int x, int y, int z, int w) {
        this.x -= x;
        this.y -= y;
        this.z -= z;
        this.w -= w;
    ...
    public i32x4 csub(int x, int y, int z, int w) {
        return this.copy().sub(x, y, z, w);
    }
    public i32x4 mul(i32x4 other) {
        this.x *= other.x;
        this.y *= other.y;
        this.z *= other.z;
        this.w *= other.w;
    ...
    public i32x4 cmul(i32x4 other) {
        return this.copy().mul(other);
    }
    public i32x4 mul(int x, int y, int z, int w) {
        this.x *= x;
        this.y *= y;
        this.z *= z;
        this.w *= w;
    ...
    public i32x4 cmul(int x, int y, int z, int w) {
        return this.copy().mul(x, y, z, w);
    }
    public i32x4 div(i32x4 other) {
        this.x /= other.x;
        this.y /= other.y;
        this.z /= other.z;
        this.w /= other.w;
    ...
    public i32x4 cdiv(i32x4 other) {
        return this.copy().div(other);
    }
    public i32x4 div(int x, int y, int z, int w) {
        this.x /= x;
        this.y /= y;
        this.z /= z;
        this.w /= w;
    ...
    public i32x4 cdiv(int x, int y, int z, int w) {
        return this.copy().div(x, y, z, w);
    }
    public i32x4 max(i32x4 other) {
    ...
    public i32x4 cmax(i32x4 other) {
        return this.copy().max(other);
    }
    public i32x4 max(int x, int y, int z, int w) {
    ...
    public i32x4 cmax(int x, int y, int z, int w) {
        return this.copy().max(x, y, z, w);
    }
    public i32x4 min(i32x4 other) {
    ...
    public i32x4 cmin(i32x4 other) {
        return this.copy().min(other);
    }
    public i32x4 min(int x, int y, int z, int w) {
    ...
    public i32x4 cmin(int x, int y, int z, int w) {
        return this.copy().min(x, y, z, w);
    }
    public i32x4 sadd(int other) {
        this.x += other;
        this.y += other;
        this.z += other;
        this.w += other;
    ...
    public i32x4 csadd(int other) {
        return this.copy().sadd(other);
    }
    public i32x4 ssub(int other) {
        this.x -= other;
        this.y -= other;
        this.z -= other;
        this.w -= other;
    ...
    public i32x4 cssub(int other) {
        return this.copy().ssub(other);
    }
    public i32x4 smul(int other) {
        this.x *= other;
        this.y *= other;
        this.z *= other;
        this.w *= other;
    ...
    public i32x4 csmul(int other) {
        return this.copy().smul(other);
    }
    public i32x4 sdiv(int other) {
        this.x /= other;
        this.y /= other;
        this.z /= other;
        this.w /= other;
    ...
    public int dot(i32x4 other) {
        return x*other.x + y*other.y + z*other.z + w*other.w;
    }
    public int dist(i32x4 other) {
        return this.csub(other).mag();
    }
    public int distSq(i32x4 other) {
